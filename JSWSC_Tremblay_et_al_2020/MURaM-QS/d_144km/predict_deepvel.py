...
class deepvel(object):
    ...
    def predict(self):
        ...
        outputs[:, :, :, 0] = outputs[:, :, :, 0] * (self.vx_d_144km_max - self.vx_d_144km_min) + self.vx_d_144km_min
        outputs[:, :, :, 1] = outputs[:, :, :, 1] * (self.vy_d_144km_max - self.vy_d_144km_min) + self.vy_d_144km_min
