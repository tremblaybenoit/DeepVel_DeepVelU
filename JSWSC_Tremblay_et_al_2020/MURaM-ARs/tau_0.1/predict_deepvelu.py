...
class deepvel(object):
    ...
    def predict(self):
        ...
        outputs[:, :, :, 0] = outputs[:, :, :, 0] * (self.vx_tau_01_max - self.vx_tau_01_min) + self.vx_tau_01_min
        outputs[:, :, :, 1] = outputs[:, :, :, 1] * (self.vy_tau_01_max - self.vy_tau_01_min) + self.vy_tau_01_min
